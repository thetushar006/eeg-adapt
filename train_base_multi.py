...
# Subject indices shuffled according to per class classification accuracy
subjs = np.array([12, 8, 20, 7, 11, 21, 22, 6, 18, 25, 2, 17, 14, 1, 15, 10, 4, 23,
         19, 24, 13, 16, 9, 5, 3])
...
X_test, Y_test = get_data_multiclass(test_subj)
